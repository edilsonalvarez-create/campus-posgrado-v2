      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <main className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            ...
            cuenta y decidir en qué cursos o programas te matricula antes de que puedas acceder al
            contenido. Te avisaremos cuando esté lista — por ahora puedes cerrar sesión y volver más
            tarde.
          </p>
        </main>
      </div>
